package com.memmcol.accountcreation.config;
...
@EnableJpaRepositories(
        basePackages = "com.memmcol.accountcreation.repository",  // ✅ FIXED: repository package
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean consolidatedEntityManagerFactory(
        ...
        emf.setPackagesToScan("com.memmcol.accountcreation.domain.entity");  // ✅ entities here
